...
from app.routers import auth, listings, admin, agents, valuation, directory
...
app.include_router(directory.router, prefix=f"{settings.API_V1_STR}/directory", tags=["directory"])
